<!-- dck-version:start -->
**Documentation version:** `1.24.4`
**Project release:** `v1.24.4`
<!-- dck-version:end -->
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.24.4-blue?style=flat-square">
...
<!-- dck-release:start -->
**v1.24.4** — Documentation, installation, AppImage, update, and release automation are synchronized from the root `VERSION` file.
<!-- dck-release:end -->
