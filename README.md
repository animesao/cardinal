...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.61.1-blue?style=flat-square">
...
**v1.61.1** — Documentation, installation, AppImage, update, and release automation are synchronized from the root `VERSION` file.
