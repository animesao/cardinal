...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.60.9-blue?style=flat-square">
...
<!-- dck-release:start -->
**v1.60.9** — Documentation, installation, AppImage, update, and release automation are synchronized from the root `VERSION` file.
<!-- dck-release:end -->
