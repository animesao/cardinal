<!-- dck-version:start -->
**Documentation version:** `1.23.23`
**Project release:** `v1.23.23`
<!-- dck-version:end -->

<p align="center">
  <!-- dck-version-badge:start -->
  <img src="https://img.shields.io/badge/version-v1.23.23-blue?style=flat-square">
...
<!-- dck-release:start -->
**v1.23.23** — Documentation, installation, AppImage, update, and release automation are synchronized from the root `VERSION` file.
<!-- dck-release:end -->
