...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v2.0.5-blue?style=flat-square">
...
**v2.0.5** — Documentation, installation, AppImage, update, and release automation are synchronized from the root `VERSION` file.
