<!-- dck-version:start -->
**Documentation version:** `1.23.19`
**Project release:** `v1.23.19`
<!-- dck-version:end -->
...
<!-- dck-release:start -->
**v1.23.19** — Documentation, installation, AppImage, update, and release automation are synchronized from the root `VERSION` file.
<!-- dck-release:end -->
