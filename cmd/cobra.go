...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  # Run a web server with resource limits
  dck run -d --ram 8g --cpu 2 -p 8080:80 --name web --restart always nginx

  # Interactive shell
  dck run -it --rm alpine sh

  # Run with volumes, env, and network
  dck run -d -v /data:/app/data:ro -e DB_HOST=localhost --network mynet myapp

  # Start API server with auto-start on boot
  ...
  dck cluster join --bind 10.0.0.2 --port 7946
